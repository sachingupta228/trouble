...
export var squareRoot: Pick<CodingContractTypes, CodingContractName.SquareRoot> = {
...
${data}`;
    ...
    generate(): [string, string] {
      ...
      var ans = randomBigIntExclusive(half) + half;
      let offset: bigint;
